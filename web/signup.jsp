    ...
    <body>
       <div class="formlogin">
            ...
            <form method="POST" action="LoginServlet" >
                ...
                <input type="password" id="password" name="password" placeholder="Mot de passe.."required="required"/><br><!-- comment -->
                <input type="password" id="validepassword" name="validepassword" placeholder="Confirmer votre mot de passe.."required="required"/><br><!-- comment -->
