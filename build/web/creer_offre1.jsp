...
<html>
    ...
    <body>
        ...
        <form class="form-offre-1" method="POST" action="CreateOffre">
            ...
            <input type="text" class="titre-de-offre" name="titre_offre" placeholder="Titre de l'offre.." value=<c:if test="${!empty titre}"><c:out value="${titre}"/></c:if> />
            </br>
            ...
            <textarea name="description_offre" class="description-de-offre" placeholder="Description.." ><c:if test="${!empty description}"><c:out value="${description}"/></c:if></textarea>
