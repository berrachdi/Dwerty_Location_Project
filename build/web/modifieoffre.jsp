<%-- 
    Document   : modifieoffre
    Created on : 16 févr. 2021, 19:26:26
    Author     : kh
--%>
...
<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-light navbar-expand bg-light navigation-clean">
            <div class="container"><img src="img/LOGO1.png" width=45px height=45px/><a class="navbar-brand" href="#">Dwerty</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"></button>
                <div class="collapse navbar-collapse" id="navcol-1">
                    <a class="navbar-brand" href="http://localhost:8081/DwertyOfficiel/CreateOffre" style="margin-left: 10%;font-size: 17px;">Creer un offre</a>
        ...
        <form  method="post" action="ModifieOffre">
            <textarea class="offre-titre" name="offre_titre"><c:out value="${logement.titre_log_logement}"></c:out></textarea>
                ...
                <select name="offre_ville" class="offre-ville">
                    ...
                    <option value=<c:out value="${logement.adress_log_logement}"></c:out>><c:out value="${logement.adress_log_logement}"></c:out></option>
                ...
                <div class="offre-info">
                    ...
                    <p class="offre-chambre-double-lit" name="offre_chambre_double_lit"><b><input type="number" name="nbr_chambre_offre" value=<c:out value="${logement.nbr_chambre_total} "></c:out>/> chambre , <input type="number" name="nbr_chambre_double" value=<c:out value="${logement.nbr_lit_double} "></c:out> /> chambre double , <input type="number" name="nbr_lits_total" value=<c:out value="${logement.nbr_lit} "></c:out>/> lits en total</b></p>
                <p class="offre-persone" name="offre_persone"><b>Support jusqu'à <input type="number" name="offre_personne" value=<c:out value=" ${logement.persone_capacite_logement} "></c:out>/> personnes </b></p>
                <p class="offre-prix" name="offre_prix" style="color:green"><b>Prix: <input class="offre-prix-mod" name="offre_prix" type="number" value=<c:out value=" ${logement.prix_log_logement} "></c:out>/> dh / Nuit</b></p>
                <c:if test="${logement.is_hotel_logement == 0}">
                    <p><b class="disponibilite" style="color: #000">Disponibilite de l'offre</b></p>

                    <p class="offre-date-disponibilite" name="offre_date_disponibilite" style="color:red;"> <b>Sera disponible le :<c:out value="  ${logement.disponibilite_log_logement}"></c:out></b> <b style="color: orange;margin-left: 10px;">changer la date :</b> <input type="date" name="offre_date_mod" class="offre-date-mod" style="margin-left: 10px;"/></p>
                ...
                <p class="offre-description" name="offre_description"><b>Description géneral</b><br><textarea name="offre_desc" class="offre-desc">${logement.desc_general_logement}</textarea></p>
