<%-- 
    Document   : creer_offre
    Created on : 6 févr. 2021, 18:48:25
    Author     : kh
--%>
...
<html>
    ...
    <body>
        ...
        <form class="form-offre-1" method="POST" action="CreateOffre">
            ...
            <label class="lbl-chambre-double">Chambres doubles</label> <select name="chambre_double_offre" class="chambre-double-de-offre">
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
            </select></br>
            ...
            <label class="lbl-prix">Prix / Nuit ( DH ) </label><input type="number" class="prix-offre" name="prix_offre" placeholder="129.99"/></br>
            <label class="lbl-date">La date de disponibilité du logement </label><input type="date" name="date_offre" class="date-offre"/></br>
               
               <label class="lbl-max">Nombre max des personnes </label><input type="number" class="max-offre" name="max_offre" placeholder="1"/></br>
