<%-- 
    Document   : home
    Created on : 10 févr. 2021, 01:34:33
    Author     : kh
--%>
...
<html>
    ...
    <body>
        ...
        <header class="masthead text-white text-center" style="background:url('img/agadir.jpg')no-repeat center center;background-size:cover;">
                    ...
                    <div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
                        <form method="GET" action="HomeServlet">
                            <div class="form-row">
                                ...
                                <div class="col-12 col-md-4 mb-2 mb-md-0"><select class="btn btn-primary btn-block btn-lg" name="search_ville" style="background-color: white;color:blue; border-radius: 20px 0px 0px 20px;">
                                ...
                                <div class="col-12 col-md-3 mb-2 mb-md-0"><select class="btn btn-primary btn-block btn-lg" name="prix_search" style="background-color: white;color:blue;border-radius: 0px; ">
                                ...
                                <div class="col-12 col-md-2 mb-2 mb-md-0"><select class="btn btn-primary btn-block btn-lg" name="lit_search" style="background-color: white;color:blue;border-radius: 0px; ">
                                ...
                                <div class="col-12 col-md-3"><button class="btn btn-primary btn-block btn-lg" name="search" value="search" type="submit" style="background-color: white;color: blue; border-radius: 0px 20px 20px 0px;height: 45px;">Chercher</button></div>
        ...
        <c:forEach items="${logement}" var="offre">
            ...
            <form class="composon" action="DetaisOffre" type="GET">
                ...
                <img src=<c:out value="${offre.url}"></c:out> width="337px" height="200px" class="img-1"/>
                ...
                <p class="prix-1" name="offre_prix"><c:if test="${!empty searchx}">${offre.nbrLit}</c:if> Lits | Prix : <c:out value="${offre.prix}"></c:out>dh /nuit</p>
                <div class="note">
