<%-- 
    Document   : showoffre
    Created on : 15 févr. 2021, 20:49:47
    Author     : kh
--%>
...
<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-light navbar-expand bg-light navigation-clean">
            <div class="container"><img src="img/LOGO1.png" width=45px height=45px/><a class="navbar-brand" href="#" style="color:#3963FF;"><b>Dwerty</b></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"></button>
                <div class="collapse navbar-collapse" id="navcol-1">
                    ...
                    <a class="navbar-brand" href="http://localhost:8081/DwertyOfficiel/ShowOffre" style="margin-left: 3%;font-size: 17px;">Afficher mes offres</a>
